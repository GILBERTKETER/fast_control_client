...
export default class FormElementsEdit extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            dirty: false,
            optionsApiURL: this.props?.element?.optionsApiURL ?? '',
        };
    }
    ...
    addOptions() {
        const optionsApiUrl = this.state.optionsApiURL;
        if (optionsApiUrl) {
    ...
    render() {
        ...
        return (
            <div>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <input
                                        ...
                                        value={this.state.optionsApiURL}
                                        onChange={e => {
                                            this.setState({ optionsApiURL: e.target.value });
                                        }}
                                    />
                                </div>
                                <div className="col-sm-6">
                ...
                {this.props.element.hasOwnProperty('options') && (
                    <div className="form-group">
                        <label className="control-label">Configure Options Dropdown</label>
                        <div className="row">
                            <div>
                                <label htmlFor="opt_label">Option Label Field</label>
                                <select
                                    className="form-control"
                                    id="opt_label"
                                    onChange={e => {
                                        this.props?.handleOptionLabelFieldChange &&
                                            this.props?.handleOptionLabelFieldChange(
                                                this.props?.element?.field_id ?? null,
                                                e.target.value
                                            );
                                    }}
                                >
                                    {this.props?.optionsConfig[this.props.element.field_id ?? null]
                                        ?.availableOptions?.length > 0 ? (
                                        this.props.optionsConfig[
                                            this.props.element.field_id ?? null
                                        ]?.availableOptions?.map((field_relation, ix) => (
                                            <option
                                                key={ix}
                                                value={field_relation ?? ''}
                                                selected={
                                                    this.props?.optionsConfig[
                                                        this.props.element.field_id ?? null
                                                    ]?.labelField === field_relation
                                                }
                                            >
                                                {field_relation ?? ''}
                                            </option>
                            ...
                            <div>
                                <label htmlFor="opt_label">Option Value Field</label>
                                <select
                                    className="form-control"
                                    id="opt_label"
                                    onChange={e => {
                                        this.props?.handleOptionValueFieldChange &&
                                            this.props?.handleOptionValueFieldChange(
                                                this.props?.element?.field_id ?? null,
                                                e.target.value
                                            );
                ...
                {this.props.element.hasOwnProperty('options') && (
                    <DynamicOptionList
                        ...
                        element={this.props.element}
                        key={this.props.element.options?.length ?? uuid()}
                    />
                )}
                {this.props.element.hasOwnProperty('canHaveAnswer') && (
                    <div className="form-group">
                        <label className="control-label">Link to Table field</label>
                        <div className="row">
                            {this.props?.selectedTable?.fields?.length > 0 ? (
                                <Radio.Group
                                    direction="vertical"
                                    onChange={val => {
                                        this.props?.onFieldLinkSelect &&
                                            this.props.onFieldLinkSelect(
                                                val,
                                ...
                                >
                                    {this.props.selectedTable?.fields
                                        ?.map((selected_table_field, ix) => (
                                            <Radio
                                                key={ix}
                                                name={this.props.selectedTable?.name}
                                                value={selected_table_field?.id}
                                                disabled={
                                                    selected_table_field?.isLinked?.status ?? false
                                                }
                                            >
                                                {selected_table_field?.name}
                                            </Radio>
                                        ))
                                        .concat(
                                            <Radio
